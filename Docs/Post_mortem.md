...
### Yago Milagres Passos (Scrum Master)

  Imaginei que a matéria seria parecida com Desenvolvimento de software, que, apesar de introdutória, ja me inseriu no mundo de desenvolvimento em equipe e abriu minha mente para todos esses métodos e boas práticas que envolvem um bom engenheiro de software. Em MDS aprendi <strong>muito</strong> mais sobre o método agil, as diferenças e importancias das softs e hard skills, além de diversas outras ferramentas que auxiliam na hora das comunicações entre a equipe e no processo de elaboração do projeto, seja em issues, histórias de usuários, pontuação ou protótipos.
  Nosso desenvolvimento foi bem difícil. A equipe teve um entrosamento e conseguiu se ajudar bem para desenvolver o software. Mas houve uma falta de disciplina por parte de todos. Eu fiquei contente com o resultado, era bem o que a equipe esperava, mesmo que o desenvolvimento era para acontecer durante todo o semestre e nós nos empenhamos mesmo apenas na ultima semana (como a professora havia dito que aconteceria 😂).
  Eu gostaria muito de rever minha equipe futuramente, e desenvolver mais coisas com eles! Afinal, o mais importante é aprender com os erros e sempre buscar evoluir.
...
### Silas Neres (Arquiteto)

   <p align="justify"> Antes de fazer MDS, ouvia algumas pessoas falando que talvez essa fosse a matéria mais importante do curso, e ficava muito apreensivo e com receio de como seria essa matéria, no começo já senti uma diferença enorme das outras matérias, pois muita coisa era muito abstrata para mim, principalmente as termologias de programador que a professora utilizava, e as primeiras semanas foram mais voltadas para adaptação e aprender mexer no Github.
