...
[<img alt="tagPython" src="https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white">](https://www.python.org/downloads/)
...
É recomendada a utilização de versões >= _**3.10.0**_, que podem ser encontradas ao clicar na tag de python acima,onde a versão mais recente será maior que a _**3.10.0**_, porém recomendamos que a versão seja a mais proxima da _**3.10.0**_ possivel.
